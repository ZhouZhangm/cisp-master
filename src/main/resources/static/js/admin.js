...
layui.define(['jquery', 'form', 'layer', 'element'], function (exports) {
    ...
    function CustomRightClick(id) {
        ...
        $('.layui-tab-title li').on('contextmenu', function (e) {
            ...
            l = ($(document).width() - e.clientX) < popupmenu.width() ? (e.clientX
                - popupmenu.width()) : e.clientX;
            t = ($(document).height() - e.clientY) < popupmenu.height() ? (e.clientY
                - popupmenu.height()) : e.clientY;
            popupmenu.css({
                left: l,
                top: t
            }).show();
    ...
    $("#rightMenu li").click(function () {
        ...
        if (type == "current") {
            ...
            var othis = $('.layui-tab-title').find('>li[lay-id="' + layId + '"]'),
                ...
                item = parents.children('.layui-tab-content').children(
                    '.layui-tab-item'),
    ...
    /*
        ...
        h       弹出层高度（缺省调默认值）
    */
    window.WeAdminShow = function (title, url, w, h, x) {
    ...
    window.WeAdminEdit = function (title, url, id, w, h) {
        ...
        layer.open({
            ...
            success: function (layero, index) {
                ...
                body.contents().find("#house").val(id);
                console.log(id);
            },
